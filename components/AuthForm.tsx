  ...
  return (
    <section className='auth-form'>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <CustomInput 
        control={form.control} name='address1' label='Address' placeholder='Enter your state'
        />
        <div className='flex gap-4'>
        <CustomInput 
        ...
        />
        <CustomInput 
        control={form.control} name='ssn' label='SSN' placeholder='Social Security Number'
        />
        </div>
            </>
        )}
